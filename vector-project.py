# Linear Algebra
#
# Calculate Vector Projections off of two given
# Basis vectors b1, b2. 
#
# Applications for this involve game-dev, aproximations,
# graphics, and more! cool stuff. I should make a visualized
# program for this (foreshadowing). Ill see yall in the 
# future ;) Hello from April 2024
#
